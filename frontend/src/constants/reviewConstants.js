...
export const REVIEW_COMMENT_REQUEST = 'REVIEW_COMMENT_REQUEST'
export const REVIEW_COMMENT_SUCCESS = 'REVIEW_COMMENT_SUCCESS'
export const REVIEW_COMMENT_FAIL = 'REVIEW_COMMENT_FAIL'
export const REVIEW_COMMENT_RESET = 'REVIEW_COMMENT_RESET'

export const REVIEW_TOP_REQUEST = 'REVIEW_TOP_REQUEST'
export const REVIEW_TOP_SUCCESS = 'REVIEW_TOP_SUCCESS'
export const REVIEW_TOP_FAIL = 'REVIEW_TOP_FAIL'
